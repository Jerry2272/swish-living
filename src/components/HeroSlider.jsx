        ...
        {slideData.map((slide, i) => (
          <div key={i}>
            <section
              ...
              style={{
                backgroundImage: `linear-gradient(90deg, rgba(213, 191, 167, 1) 10%, rgba(0, 0, 0, 0.40) 100%), url(${slide.img})`,
            ...
            >
              <div className="text-white space-y-6 max-w-3xl animate-fade-in-up">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-3 bg-gradient-to-r from-[#d5bfa7] to-[#000000]
)
