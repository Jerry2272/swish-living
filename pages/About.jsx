...
const About = () => {
  return (
    <div className=" ">
      {/* Hero Section */}
      <section className="relative bg-black text-white py-20 px-6 text-center h-[60vh] flex justify-center items-center ">
        <div className="absolute inset-0 opacity-20 bg-cover bg-center" style={{ backgroundImage: `url(${aboutImage})` }}></div>
        <div className="relative z-10 max-w-3xl mx-auto">
          <h1 className="md:text-5xl text-4xl font-bold mb-4">About Swish Living</h1>
  ...
  <div className="max-w-6xl mx-auto text-center">
    ...
    <div className="grid md:grid-cols-3 gap-10">
      <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
        <FaStar className="text-[#7e563c] text-4xl mb-4 mx-auto" />
      ...
      <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
        <FaCouch className="text-[#7e563c] text-4xl mb-4 mx-auto" />
      ...
      <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
        <FaTruck className="text-[#7e563c] text-4xl mb-4 mx-auto" />
